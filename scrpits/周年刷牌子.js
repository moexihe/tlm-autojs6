...
function handleUnknownScene() {
    ...
    let closeText = U.ocrRegionCenter(P.关闭[0], P.关闭[1], 300, 351, P.REF_WIDTH, P.REF_HEIGHT) || [];
    ...
    let backText = U.ocrRegionCenter(P.返回[0], P.返回[1], 300, 351, P.REF_WIDTH, P.REF_HEIGHT) || [];
